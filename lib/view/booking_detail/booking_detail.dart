    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Consumer<BookingProvider>(builder: (context, bookProv, _) {
            ...
            if (bookProv.requestState == RequestState.loading) {
              return SizedBox(
                ...
                return Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                          ...
                          height: 220,
                          child: Image.network(
                              'http://18.141.56.154:8000/${i.imageBanner}',
                              errorBuilder: (BuildContext context,
                                  Object exception, StackTrace? stackTrace) {
                            // Gambar tidak tersedia (404), gunakan gambar dari file assets
