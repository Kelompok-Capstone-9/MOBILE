...
class SearchLocView extends StatefulWidget {
  var prov;
  ...
  @override
  State<SearchLocView> createState() => _SearchLocViewState();
}

class _SearchLocViewState extends State<SearchLocView> {
